 ...
 * @version    SVN: $Id: vbFormPropel.class.php 11363 2008-09-07 18:20:10Z FabianLange $
 */

/**
 * vbFormPropel is the base class for forms based on Propel objects.
 *
 * @package    symfony
 * @subpackage form
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @version    SVN: $Id: vbFormPropel.class.php 11363 2008-09-07 18:20:10Z FabianLange $
 */
abstract class vbFormPropel extends vbForm
{
  protected
    $isNew    = true,
    $cultures = array(),
  ...
  public function get_param ($parameterName, $namespace = null) {
  	if ($namespace == null) {
        $namespace = substr($this->getWidgetSchema()->getNameFormat(), 0, strpos($this->getWidgetSchema()->getNameFormat(), '['));
  	}

    return parent::get_param ($parameterName, $namespace);
  }
}
